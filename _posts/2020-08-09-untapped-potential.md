...
**Facebook** - In 2016, I led an 8-week technology pilot project to introduce a new analytical engine to Facebook (to replace their need for Vertica) working alongside the Data Engineering Director at Facebook (Guy Bayes) ultimately sending several emails to the CIO (Tim Campos) to report our successful project. Success of pilot led to $6.5 million of MicroStrategy licenses (3.5M recurring and 3M new). 

**Carrefour** - in 2017, I Lambda Architecture to explore using kafka with some of their largest datasets in HDFS. 750K

**Early Adopter Program** - In 2015-2016 I 20% . customers using the platform were 65% more likely to renew 
